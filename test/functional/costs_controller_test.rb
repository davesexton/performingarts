...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { description: @cost.description, full_term_price: @cost.full_term_price, half_term_price: @cost.half_term_price }
    end
  ...
  test "should update cost" do
    put :update, id: @cost, cost: { description: @cost.description, full_term_price: @cost.full_term_price, half_term_price: @cost.half_term_price }
    assert_redirected_to cost_path(assigns(:cost))
  end
